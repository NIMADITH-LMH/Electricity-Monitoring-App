          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ...plans.map((plan) => _buildPlanCard(plan, plan.id == selectedPlan?.id)).toList(),
                const SizedBox(height: 24),
        ...
        child: CustomCard(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              ...plan.recommendations.map((recommendation) => _buildRecommendationItem(recommendation)).toList(),
            ],
          ),
        ),
      ),
